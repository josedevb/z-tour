...
class AchievementComplete extends React.Component {
            ...
            >
                <View style={styles.container}>
                    ...
                    <View style={styles.mainTextContainer}>
                        <View >
                            <Text style={styles.getStartedText}>¡COMPLETASTE LOS LOGROS DE LA RUTA Z-TOUR!</Text>
                        </View>
                        <Image style={styles.camStyles} source={require('../assets/icons/victory.png')} />
                    </View>
                    <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('App',{showComplete:true})}>
...
export default AchievementComplete;
